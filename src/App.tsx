...
import { Home, User, MessageSquare, Bell, Menu, Search, Plus } from 'lucide-react';
    ...
    >
      ...
      <div className="mt-auto mb-4">
         <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-[rgb(var(--color-primary))] to-[rgb(var(--color-accent))] p-0.5 cursor-pointer">
            <img src="https://i.pravatar.cc/150?u=me" alt="User" className="w-full h-full rounded-full object-cover border-2 border-[rgb(var(--color-background))]" />
         </div>
      </div>
    </motion.div>
  );
